...
public static class Requirement
{
	...
	/// <summary>
	///     Creates a new <see cref="Requirement{TEntity}" /> by delegating it for all <typeparamref name="TDelegate" />
	///     generated by the <paramref name="delegateGenerator" /> to the <paramref name="requirementGenerator" />.
	///     <para />
	///     For each <typeparamref name="TDelegate" /> created by the <paramref name="delegateGenerator" /> a corresponding
	///     <see cref="Requirement{TDelegate}" /> is created by the <paramref name="requirementGenerator" /> and used to
	///     populate the total list of errors.
	/// </summary>
	public static Requirement<TEntity> Delegate<TEntity, TDelegate>(
		Func<TEntity, IEnumerable<TDelegate>> delegateGenerator,
		Func<TEntity, Requirement<TDelegate>> requirementGenerator)
		=> new DelegateRequirement<TEntity, TDelegate>(delegateGenerator, requirementGenerator);
	...
	private sealed class DelegateRequirement<TEntity, TDelegate> : Requirement<TEntity>
	{
		private readonly Func<TEntity, IEnumerable<TDelegate>> _delegateGenerator;
		private readonly Func<TEntity, Requirement<TDelegate>> _delegateRequirement;

		public DelegateRequirement(
			Func<TEntity, IEnumerable<TDelegate>> delegateGenerator,
			Func<TEntity, Requirement<TDelegate>> delegateRequirement)
		{
