...
public sealed partial class ExtensionsForITypeExpectationTests
{
	public sealed class InheritFrom
	{
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom<FooBase>(
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom(
				...
				bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom(typeof(IFooInterface),
				forceDirect: forceDirect);
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom(typeof(GenericFooClass<>),
				forceDirect: forceDirect);
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom<IFooInterface>(
				forceDirect: forceDirect);
		...
		public void ShouldInheritFrom_WithGenericClass_ShouldBeSatisfied()
		{
			...
			IExpectationConditionResult<Type>
		...
		public void ShouldInheritFrom_WithoutClass_ShouldNotBeSatisfied()
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom<BarClass>();
		...
		public void ShouldInheritFrom_WithoutInterface_ShouldNotBeSatisfied()
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldInheritFrom<IOtherFooInterface>();
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom<FooBase>(
				forceDirect: forceDirect);
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom(
				typeof(IGenericFooInterface<>),
				forceDirect: forceDirect);
				...
				bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom(typeof(IFooInterface),
				forceDirect: forceDirect);
			...
			bool forceDirect)
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom<IFooInterface>(
				forceDirect: forceDirect);
		...
		public void ShouldNotInheritFrom_WithoutClass_ShouldBeSatisfied()
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom<BarClass>();
		...
		public void ShouldNotInheritFrom_WithoutInterface_ShouldBeSatisfied()
		{
			...
			IExpectationConditionResult<Type> result = sut.ShouldNotInheritFrom<IOtherFooInterface>();
